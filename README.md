...
- **Awareness** — [Track Map](#track-map) · [Proximity Radar](#proximity-radar) · [Radar Bar](#radar-bar) · [Duel Bar](#duel-bar) · [Flags (LED/Flat)](#flags-led--flat)
...
![Duel Bar](docs/assets/screenshots/widgets/Duel-Bar.png)
