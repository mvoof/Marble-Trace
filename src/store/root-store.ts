...
import { PitServiceWidgetStore } from '@widgets/PitServiceWidget/pit-service.widget';
import { StandingsWidgetStore } from './widgets/standings.widget';
import { TrackMapWidgetStore } from '@widgets/TrackMapWidget/track-map.widget';
import { DrivingCoachWidgetStore } from '@widgets/CoachWidget/driving-coach.widget';
import { CoachWidgetStore } from '@widgets/CoachWidget/coach.widget';
import { InputTraceWidgetStore } from '@widgets/InputTraceWidget/input-trace.widget';
...
import { StreamChatWidgetStore } from '@widgets/StreamChatWidget/stream-chat.widget';
