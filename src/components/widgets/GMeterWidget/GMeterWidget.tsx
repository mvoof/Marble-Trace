...
export const GMeterWidget = forwardRef<GMeterHandle, GMeterWidgetProps>(
  ({ displayMode, scale, colorMode }, ref) => {
    ...
    const drawFrame = (canvas: HTMLCanvasElement) => {
      ...
      for (let g = 1; g <= maxG; g++) {
        ...
        ctx.strokeStyle =
          g === maxG ? 'rgba(58,59,64,1)' : 'rgba(42,43,48,0.8)';
        ctx.stroke();
      }
...
GMeterWidget.displayName = 'GMeterWidget';
