...
export type TelemetryFrame = {
  ...
  driver_car_sl_first_rpm: number | null;
  driver_car_sl_shift_rpm: number | null;
  driver_car_sl_last_rpm: number | null;
  driver_car_sl_blink_rpm: number | null;
  driver_car_red_line: number | null;
  driver_car_idle_rpm: number | null;
};
